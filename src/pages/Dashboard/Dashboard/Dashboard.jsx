...
const Dashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col lg:flex-row">
            {/* Sidebar */}
            <div
                className={`lg:w-72 w-64 h-full bg-[#18181B] text-white p-5 fixed top-0 left-0 z-20 transform transition-transform duration-300 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 flex flex-col`}
            >
            ...
            <div className="flex-1 lg:ml-72">
                {/* Header */}
                <header className="bg-[#18181B] p-5 sticky top-0 z-10 shadow-md flex justify-between lg:justify-end items-center">
